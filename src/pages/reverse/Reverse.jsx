...
const Reverse = () => {
  ...
  return (
    <section className="reverse">
      {randomCountry && (
        <div className="reverse_form">
          <div className="reverse_country_name">
            <h1>{randomCountry.capital}</h1>
          </div>
          <div
            className={`reverse_score_status ${isCorrect ? "correct" : ""} ${
          ...
          <div className="reverse_p2">
            {randomAnswers.length > 0 &&
              randomAnswers.map((country) => (
                <button
                  key={country.capital}
                  className={`reverse_answer ${
          ...
          {finished && <div className="reverse_status">No capitals left</div>}
          <div className="reverse_score">
            <div className="reverse_score_p">{score} pts</div>
            <div className="reverse_score_img">
